...
(() => {
  ...
  // node_modules/.pnpm/@firebase+app@0.10.12/node_modules/@firebase/app/dist/esm/index.esm2017.js
  ...
  // node_modules/.pnpm/@firebase+auth@1.7.9_@firebase+app@0.10.12/node_modules/@firebase/auth/dist/esm2017/index-68602d24.js
  ...
  self.addEventListener("fetch", (event) => {
    ...
    const requestProcessor = (idToken) => {
      ...
      if (self.location.origin == getOriginFromUrl(evt.request.url) && (self.location.protocol == "https:" || self.location.hostname.startsWith("localhost")) && idToken) {
        const headers = new Headers();
        req.headers.forEach((val, key) => {
          headers.append(key, val);
        });
        headers.append("Authorization", "Bearer " + idToken);
        processRequestPromise = getBodyContent(req).then(
          (body) => {
            try {
